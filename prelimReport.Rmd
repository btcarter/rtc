...
Categorical variables (i.e. variables that were nominal rather than quantitative in nature) we examined in relation to readiness to change diet or exercise using a Pearson's chi-square analysis. What follows are the reported $\chi^2$ statistics, degrees of freedom, and p-values from each test.
...
I have a few thoughts on these data