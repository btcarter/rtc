...
Core attendance can be predicted by readiness to change diet (*p* = `r linear_models[["Core attendance"]]$diet$p.value`) or exercise (*p* = `r linear_models[["Core attendance"]]$exercise$p.value`).
