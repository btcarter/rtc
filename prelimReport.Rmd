...
The real question is - which model performs best? The simple or complex? What actually improve the model?

```{r}
# which performs best?
anova(log_simple$`Lost 7 percent during core`$model, log_complex$`Lost 7 percent during core`$model, test = "Chisq")

# which terms improve the model?
anova(log_simple$`Lost 7 percent during core`$model, test = "Chisq")
```
