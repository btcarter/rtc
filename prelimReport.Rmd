...
## Potential interaction in readiness to change
...
a <- as.data.frame(
  summary(log_simple[[mod]])$coefficients
)

aic <- log_simple[[mod]]$aic
```
...
a <- as.data.frame(
  summary(log_complex[[mod]])$coefficients
)

aic <- log_complex[[mod]]$aic
```
